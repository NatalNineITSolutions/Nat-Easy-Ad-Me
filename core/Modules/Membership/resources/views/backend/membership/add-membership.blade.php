        ...
        <div class="col-xl-6 col-lg-6">
            <div class="dashboard__card bg__white padding-20 radius-10">
                ...
                <form action="{{route('admin.membership.add')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <x-form.text :title="__('Price')" :required="'required'" :type="__('number')" :name="'price'"
                    ...
                    <div class="form__input__single d-grid">
                        <label
                            for="user_otp_verify_enable_disable"><strong>{{ __('Enquiry Form (Allowed/Not Allowed)') }}</strong></label>
                    ...
                    <div class="form__input__single d-grid">
                        <label
                            for="membership_badge"><strong>{{ __('Membership Badge (Allowed/Not Allowed)') }}</strong></label>
                        <div class="switch_box style_7">
                    ...
                    <div class="form__input__single">
                        <div id="features">
                            <div class="attr single-input-feature-attr">
                                <input name="feature[]" class="feature form-control" type="text"
                                    placeholder="{{ __('Enter feature') }}">
                                <div class="checkbox-inline style_1">
                                    <input name="status[]" type="checkbox"
                                        class="required-entry single-input-feature-checkbox check-input">
                                </div>
                        ...
                        <a href="javascript:void(0)" type="button"
                            class="cmn_btn btn_small radius-5 add mt-3">{{ __('Add Features') }}</a>
                    </div>
                    <div class="btn_wrapper mt-4">
                        <button type="submit" id="update"
                            class="cmnBtn btn_5 btn_bg_blue radius-5 validate_membership_type">{{ __('Submit') }}</button>
                    </div>
                </form>
            </div>
        </div>
