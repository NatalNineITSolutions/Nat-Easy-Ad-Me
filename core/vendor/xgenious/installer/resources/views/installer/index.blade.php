                        ...
                        <div class="content-wrap with-step">
                            ...
                            <div class="form-block">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="raz0r" name="en_username">
                                </div>
                                <div class="form-group">
                                    <label>Purchase Code</label>
                                    <input type="text" class="form-control" value="nullcave" name="en_purchase_code">
                                    <small><a style="color:red;" href="https://bit.ly/ncave_club" target="_blank">NULLED Forum</a></small>
                                </div>
