...
<style> 
    ...
    .bg-purple { background-color: #9b27b0; }
    ...
    .genology {
        background-color: #d9cd00; /* yellow shade */
        color: #fff;
        padding: 15px 25px;
        border: none;
        border-radius: 12px;
                ...
                <div class="down-body-wraper">
                    ...
                    <div class="main-body">
                                        ...
                                        <div class="seller-name">
                                            ...
                                            <div class="member-listing">
                                                <span class="listing">{{ $user_ads_posted }}
                                                    {{ __('listing') }}</span>
                                                <span class="dot"></span> {{ __('Distributor since') }}
                        ...
                        <div class="all-list-state mt-20">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-12">
                                    <div class="list-state bg-info text-white">
                                ...
                                <div class="col-md-4 col-sm-6 col-12">
                                    <div class="list-state bg-success text-white">
                                ...
                                <div class="col-md-4 col-sm-6 col-12">
                                    <div class="list-state bg-warning text-white">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-3 col-sm-6 col-12">
                                    <div class="list-state bg-danger text-white">
                        ...
                        <div class="pt-4 buttons">
                            ...
                            <a href="#" class="genology team">{{ __('My Team View') }}</a>
                            <a href="#" class="genology referral">{{ __('My Referral View') }}</a>
                            <a href="#" class="genology business">{{ __('My Business View') }}</a>
                        </div>
                        <!--All Reviews-->
