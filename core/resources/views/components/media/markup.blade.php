        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="popup_contents__header__close">
                    <button type="button" class="popup_contents__close popup_close close" aria-label="Close"
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#media_library" role="tab"
                            data-type="{{ $type }}" id="load_all_media_images" aria-controls="media_library"
