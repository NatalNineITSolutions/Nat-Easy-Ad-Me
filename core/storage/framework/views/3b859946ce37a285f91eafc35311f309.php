...
<div class="pricingCard mt-4">
    <div class="row g-3">
        <?php
            $memberships = \Modules\Membership\app\Models\Membership::where('status', 1)
                ->where('category', 0)
                ->take(3)
                ->get();
        ...
        <?php $__currentLoopData = $memberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 col-sm-6">
                <div
                    class="singlePrice <?php if(!empty($user_current_membership) && $user_current_membership->membership_id === $membership->id): ?> active <?php endif; ?>">
                    ...
                    <div class="btn-wrapper">
                        ...
                        <?php else: ?>
                                        ...
                                        <button class="cmn-btn-outline1 choose_membership_plan" data-bs-toggle="modal"
                                            data-id="<?php echo e($membership->id); ?>" data-price="<?php echo e($membership->price); ?>"
...
</div><?php /**PATH C:\laragon\www\Nat-Easy-Ad-Me\core\Modules/Membership\resources/views/frontend/user/membership/user-dashboard-membership-plans.blade.php ENDPATH**/ ?>