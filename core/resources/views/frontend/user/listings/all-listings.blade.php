                                                ...
                                                <div class="single-add-card">
                                                        ...
                                                        <div class="single-add-body">
                                                            <h5 class="add-heading head4 oneLine">
                                                                <a href="{{route('frontend.listing.details', $listing->slug ?? 'x')}}"
                                                                    target="_blank"> {{ $listing->title }}</a>
                                                            </h5>
                                                            @if($listing->category_id != 54)
                                                                <div class="pricing head4">
                                                                    {{ amount_with_currency_symbol($listing->price) }}</div>
                                                            @endif
                                                            ...
                                                            <div class="btn-wraper">
                                                                @if($listing->status === 1)
                                                                    <a href="javascript:void(0)"
                                                                        class="approved-btn">{{ __('APPROVED') }}</a>
                                                                @else
                                                                    <a href="javascript:void(0)"
                                                    ...
                                                    <div class="right-buttons">
                                                        ...
                                                        <div class="publish-btn">
                                                            <x-status.frontend-listing-published-change :title="__('Change Status')"
                                                                :url="route('user.listing.published.status', $listing->id)"
                                                        ...
                                                        <div class="setting-btn-wraper">
                                                            ...
                                                            <div class="settings-wraper">
                                                                ...
                                                                <x-popup.frontend-listing-delete-popup
                                                                    :url="route('user.delete.listing', $listing->id)" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
