<div class="sidebar-menu-wraper box-shadow1">
    ...
    <a href="{{ route('user.products') }}"
        class="menu-item @if(request()->is('user/info/products*')) active @endif">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 24 24" fill="none" stroke="#64748B"
            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="{{ route('user.income') }}" class="menu-item @if(request()->is('user/info/income*')) active @endif">
        <svg width="20" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                d="M12 7V17M9 10H13.5C14.3284 10 15 10.6716 15 11.5C15 12.3284 14.3284 13 13.5 13H10.5C9.67157 13 9 13.6716 9 14.5C9 15.3284 9.67157 16 10.5 16H15"
        ...
        <span class="ms-2">{{ __('Income Statement') }}</span>
    </a>

    @if(moduleExists('Membership'))
        @if(membershipModuleExistsAndEnable('Membership'))
            <a href="{{ route('user.membership.all') }}"
                class="menu-item @if (request()->routeIs('user.membership.all')) active @endif">
    ...
    <a href="{{ route('user.ticket') }}"
        class="menu-item @if (request()->is('user/support-ticket/ticket')) active @endif">
    ...
    <a href="{{ route('user.listing.favorite.all') }}"
        class="menu-item  @if(request()->is('user/favorite/listing*')) active @endif">
    ...
    @if(moduleExists('Membership'))
        @if(membershipModuleExistsAndEnable('Membership'))
            <a href="{{ route('user.enquiries.all') }}"
                class="menu-item @if (request()->routeIs('user.enquiries.all')) active @endif">
    ...
    <a href="{{ route('user.profile.show') }}"
        class="menu-item @if(request()->is('user/profile/detail*')) active @endif">
        <svg width="14" height="20" viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M1 19V17C1 15.9391 1.42143 14.9217 2.17157 14.1716C2.92172 13.4214 3.93913 13 5 13H9C10.0609 13 11.0783 13.4214 11.8284 14.1716C12.5786 14.9217 13 15.9391 13 17V19M3 5C3 6.06087 3.42143 7.07828 4.17157 7.82843C4.92172 8.57857 5.93913 9 7 9C8.06087 9 9.07828 8.57857 9.82843 7.82843C10.5786 7.07828 11 6.06087 11 5C11 3.93913 10.5786 2.92172 9.82843 2.17157C9.07828 1.42143 8.06087 1 7 1C5.93913 1 4.92172 1.42143 4.17157 2.17157C3.42143 2.92172 3 3.93913 3 5Z"
                stroke="#524EB7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    ...
    <a href="{{ route('user.account.settings') }}"
        class="menu-item @if(request()->is('user/account-settings*')) active @endif">
