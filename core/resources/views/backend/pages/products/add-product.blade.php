        ...
        <div class="col-12">
            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="{{ __('Enter product name') }}"
                        required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="distributor_price" class="form-control"
                        placeholder="{{ __('Enter distributor price') }}" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">{{ __('BV Points') }}</label>
                    <input type="number" step="1" name="bv_points" class="form-control"
                        placeholder="{{ __('Enter BV points') }}">
                </div>

                <div class="mb-3">
                    <label class="form-label">{{ __('Stock') }}</label>
                    <input type="number" name="stock" class="form-control" placeholder="{{ __('Available stock') }}"
                        required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="gst" class="form-control" placeholder="Enter GST percent"
                        value="{{ old('gst', 0) }}">
                </div>
