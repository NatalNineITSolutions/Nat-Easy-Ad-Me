<?php if(moduleExists('Membership')): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\Nat-Easy-Ad-Me\core\Modules/Membership\resources/views/frontend/user/membership/user-dashboard-membership-message.blade.php ENDPATH**/ ?>