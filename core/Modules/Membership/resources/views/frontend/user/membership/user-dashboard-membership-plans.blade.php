    ...
    <div class="row g-3">
        ...
        @foreach ($memberships as $membership)
            <div class="col-lg-4 col-sm-6">
                <div class="singlePrice @if ($user_current_membership && $user_current_membership->membership_id == $membership->id) active @endif">
                    ...
                    <div class="btn-wrapper">
                        @if ($membership->price == 0)
                            ...
                            @if ($user_current_membership && $user_current_membership->membership_id == $membership->id)
                        ...
                        @else
                            ...
                            @php
                                ...
                                if ($user_current_membership) {
                                    if ($user_current_membership->membership_id == $membership->id) {
                                        ...
                                        $modalTarget = null;
                                    } elseif ($user_current_membership->membership->price < $membership->price) {
                            ...
                            @else
                                <button class="cmn-btn-outline1" disabled>{{ $buttonText }}</button>
                            @endif
                        @endif
                    </div>
