...
@section('content')
    <div class="catagory-wise-listing section-padding2">
        <div class="container-1440">
            <x-breadcrumb.user-profile-breadcrumb :title="''" :innerTitle="$child_category->category?->name" :subInnerTitle="$child_category->subcategory?->name" :chidInnerTitle="$child_category->name"
                :routeName="route('frontend.show.listing.by.category', $child_category->category?->slug ?? 'x')" :subRouteName="route('frontend.show.listing.by.subcategory', $child_category->subcategory?->slug ?? 'x')" />
                        ...
                        <div class="container-1440">
                            <div class="titleWithBtn d-flex justify-content-between align-items-center mb-40">
                                <h3 class="catagory-wise-title">
                                    {{ sprintf(__('Available Listings in :child_category', ['child_category' => $child_category->name])) }}
                                </h3>
                                            ...
                                            <div class="featurebody">
                                                ...
                                                <span
                                                    ...
                                                    @if ($listing->category_id != 54)
                                                        <span
                                                            class="money">{{ amount_with_currency_symbol($listing->price) }}</span>
                                                    @endif
                                                    <span class="date">
