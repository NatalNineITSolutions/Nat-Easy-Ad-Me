...
<script>
    ...
    $(document).ready(function (){
        $('.chat_item[data-user-id=<?php echo e(request()->user_id); ?>]').trigger('click').addClass("active")
    })
    <?php endif; ?>
    /*
    ========================================
    ...
    */
    ...
    $(document).on('click', '.chat_item', function() {
        ...
        channelName = {
            ...
            member_id: "<?php echo e(auth('web')->id()); ?>",
            type: "member"
        };
    ...
    $(document).on("click","#member-send-message-to-user", function (){
        ...
        if(messages_ != '' || file !== undefined){
            ...
            send_ajax_request("post", form, "<?php echo e(route("member.message.send")); ?>", function (){}, function (response){
    ...
    function fetch_chat_data(user_id, page = 1, callback){
        ...
        send_ajax_request("post", formData,`<?php echo e(route("member.fetch.chat.user.record")); ?>?page=${page}`,function (){
...
<?php /**PATH C:\laragon\www\Nat-Easy-Ad-Me\core\Modules/Chat\resources/views/components/member/member-chat-js.blade.php ENDPATH**/ ?>