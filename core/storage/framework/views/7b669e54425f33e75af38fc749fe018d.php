...
<?php endif; ?>
                                ...
                                <?php if(isset($mlmTree) && $mlmTree): ?>
                                    <div class="mlm-tree-container box-shadow1 mt-20">
                                        <h4 class="dis-title"><?php echo e(__('Genology')); ?></h4>
                                        <div class="tree">
                                            <ul>
                                                <?php
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Nat-Easy-Ad-Me\core\resources\views/frontend/user/dashboard/dashboard.blade.php ENDPATH**/ ?>