    ...
    (function($) {
        ...
        $(document).on('keyup', '#phone', function() {
            ...
            if (phoneRegex.test(phone) && phone != '') {
                $.ajax({
                    url: "<?php echo e(route('user.phone.number.check')); ?>",
                    type: 'post',
                    data: {
                        phone: phone
                    },
...
<?php /**PATH C:\laragon\www\Nat-Easy-Ad-Me\core\Modules/SMSGateway\resources/views/user/phone-number-check.blade.php ENDPATH**/ ?>