...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        View::composer('*', function ($view) {
            ...
            $user_ads_posted = ($user && $user->listings) ? $user->listings->count() : 0;
            ...
            if ($user) {
                ...
                $user_ads_posted = $userWithData->listings_count ?? 0;

                $remaining_listings = max(0, $remaining_listings);
                ...
                $view->with([
                    ...
                    'global_remaining_listings' => $remaining_listings
                ]);
            }
        });
