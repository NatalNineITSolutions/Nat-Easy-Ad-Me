        ...
        $(document).ready(function(){
            ...
            $(document).on('submit','#update_profile_form',function(e){
                ...
                if(first_name == '' || last_name == '' || email == '' || phone == '' || country == '' || state == ''){
                    ...
                    $('#user_profile_info_update').html('<i class="fas fa-spinner fa-spin mr-1"></i> <?php echo e(__("Submitting")); ?>');
                    // Submit the form
                    ...
                    $.ajax({
                        ...
                        success: function(res){
                            if(res.status == 'ok'){
                                ...
                                toastr_warning_js("<?php echo e(__('This is demonstration purpose only, you may not able to change few settings, once your purchase this script you will get access to all settings.')); ?>");
                            }
...
<?php /**PATH C:\laragon\www\easyadme\core\resources\views/frontend/user/profile/profile-js.blade.php ENDPATH**/ ?>