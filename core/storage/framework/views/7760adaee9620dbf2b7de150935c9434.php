    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('Background Image')); ?></h5>
            ...
            <form id="edit_profile_form" method="post">
                ...
                <div class="modal-footer">
                    <div class="btn-wrapper d-flex gap-2">
                        ...
                        <button type="submit" class="cmn-btn1 popup-modal"> <?php echo e(__('Update')); ?> </button>
                    </div>
                </div>
            </form>
        </div>
...
<?php /**PATH C:\laragon\www\easyadme\core\resources\views/frontend/user/profile/edit-profile-info-modal.blade.php ENDPATH**/ ?>