        ...
        <div class="singleRight-message">
            <div class="messageText">
                <div class="messageCaption">
                    <p class="chat-wrapper-details-inner-chat-contents-para <?php echo e(!empty($listing) ? "d-none" : ""); ?>">
                    <?php if(!empty($message->message['message'])): ?>
                        <span class="messagePera"><?php echo e($message->message['message'] ?? ''); ?></span>
                    <?php endif; ?>
...
<?php endif; ?>
                ...
                <div class="messageCaption">
                        ...
                        <?php if(!empty($message->file)): ?>
                            <br />
                            <br />
                            <img src="<?php echo e(asset('assets/uploads/media-uploader/live-chat/'. $message->file)); ?>" alt="" style="width: 150px!important;">
                                <?php
                                $ext = pathinfo($message->file, PATHINFO_EXTENSION);
                                ?>
                            <?php if($ext == 'pdf'): ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\easyadme\core\Modules/Chat\resources/views/components/user/message.blade.php ENDPATH**/ ?>