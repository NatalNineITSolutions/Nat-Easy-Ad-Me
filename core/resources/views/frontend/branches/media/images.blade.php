...
<head>
    ...
    <title>Branch Media Images</title>
    <!-- Media CSS -->
    <x-branch.css/>
    <style>
        .media-image-header {
                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title">Media Images</h4>
                        </div>
                        <div class="dashboard__inner__header__right">
                            <div class="btn-wrapper">
                                <a href="#" class="cmnBtn btn_5 btn_bg_blue radius-5" data-bs-toggle="modal" data-bs-target="#media_image_upload_modal">Add New Image</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="img-sticky-wrap">
                                <div class="media-uploader-image-info" id="media-uploader-image-info">
                                    ...
                                    <div class="img-info">
                                        ...
                                        <form method="post" action="{{route('branch.upload.media.file.delete')}}" class="delete_image_form display-none">
                                            @csrf
            ...
            <div class="modal-dialog modal_xl__fixed">
                <div class="popup_contents modal-content">
                    <div class="popup_contents__header">
                        <div class="popup_contents__header__flex">
                            <div class="popup_contents__header__contents">
                                <h2 class="popup_contents__header__title">Upload Images</h2>
                            </div>
                    ...
                    <div class="popup_contents__body">
                        <div class="alert alert-warning">Reload the page to see latest uploaded images</div>
                        <div class="dragDrop_item dragDropWrapper mt-4">
                            <div class="dragDrop__area radius-10">
                                <div class="dragDrop__area__uploads dragDroparea">
                                    <form action="{{route('branch.upload.media.file')}}" method="post" class="dropzone" enctype="multipart/form-data">
                                        @csrf
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="popup_contents__footer flex_btn justify-content-end profile-border-top">
                            <a href="javascript:void(0)" class="cmnBtn btn_5 btn_bg_danger radius-5" data-bs-dismiss="modal">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
