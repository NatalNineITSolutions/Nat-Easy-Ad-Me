<?php if(!empty(get_static_option('google_map_settings_on_off'))): ?>
    ...
    <?php if($check_google_map_for_page): ?>
        <script
            src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(get_static_option('google_map_api_key')); ?>&libraries=places&v=3.46.0">
        </script>
    <?php endif; ?>
                ...
                if (navigator.geolocation) {
                    ...
                    navigator.geolocation.getCurrentPosition(function(position) {
                        ...
                        fetch('/listing/store-location', {
                            ...
                            .then(data => console.log('Location saved in session:', data))
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\Nat-Easy-Ad-Me\core\resources\views/frontend/layout/partials/search/google-map-search-js.blade.php ENDPATH**/ ?>