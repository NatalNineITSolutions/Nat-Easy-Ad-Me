<div class="sidebar-menu-wraper box-shadow1">
    ...
    <a href="<?php echo e(route('user.genology')); ?>" class="menu-item <?php if(request()->routeIs('user.genology')): ?> active <?php endif; ?>">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <circle cx="12" cy="4" r="2"></circle>
            <line x1="12" y1="6" x2="12" y2="10"></line>
            <line x1="12" y1="10" x2="7" y2="14"></line>
            <line x1="12" y1="10" x2="17" y2="14"></line>
            <circle cx="7" cy="14" r="2"></circle>
            <circle cx="17" cy="14" r="2"></circle>
            <line x1="7" y1="16" x2="5" y2="20"></line>
            <line x1="7" y1="16" x2="9" y2="20"></line>
            <line x1="17" y1="16" x2="15" y2="20"></line>
            <line x1="17" y1="16" x2="19" y2="20"></line>
            <circle cx="5" cy="20" r="2"></circle>
            <circle cx="9" cy="20" r="2"></circle>
            <circle cx="15" cy="20" r="2"></circle>
            <circle cx="19" cy="20" r="2"></circle>
        </svg>
        <span class="ms-2"><?php echo e(__('Genology')); ?></span>
    </a>
    ...
    <?php if(moduleExists('Membership')): ?>
        <?php if(membershipModuleExistsAndEnable('Membership')): ?>
            <a href="<?php echo e(route('user.membership.all')); ?>"
                class="menu-item <?php if(request()->routeIs('user.membership.all')): ?> active <?php endif; ?>">
    ...
    <?php if(moduleExists('Wallet')): ?>
        <a href="<?php echo e(route('user.wallet.history')); ?>"
            class="menu-item <?php if(request()->routeIs('user.wallet.history')): ?> active <?php endif; ?>">
    ...
    <?php if(moduleExists('Chat')): ?>
        ...
        <?php if(!empty($member_find)): ?>
            <a href="<?php echo e(route('member.live.chat')); ?>"
                class="menu-item <?php if(request()->routeIs('user.live.chat')): ?> active <?php endif; ?>">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M14 5V2C14 1.73478 13.8946 1.48043 13.7071 1.29289C13.5196 1.10536 13.2652 1 13 1H3C2.46957 1 1.96086 1.21071 1.58579 1.58579C1.21071 1.96086 1 2.46957 1 3M1 3C1 3.53043 1.21071 4.03914 1.58579 4.41421C1.96086 4.78929 2.46957 5 3 5H15C15.2652 5 15.5196 5.10536 15.7071 5.29289C15.8946 5.48043 16 5.73478 16 6V9M1 3V15C1 15.5304 1.21071 16.0391 1.58579 16.4142C1.96086 16.7893 2.46957 17 3 17H15C15.2652 17 15.5196 16.8946 15.7071 16.7071C15.8946 16.5196 16 16.2652 16 16V13M17 9V13H13C12.4696 13 11.9609 12.7893 11.5858 12.4142C11.2107 12.0391 11 11.5304 11 11C11 10.4696 11.2107 9.96086 11.5858 9.58579C11.9609 9.21071 12.4696 9 13 9H17Z"
                        stroke="#64748B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    ...
    <!--Support Ticket -->
    <a href="<?php echo e(route('user.ticket')); ?>"
        class="menu-item <?php if(request()->is('user/support-ticket/ticket')): ?> active <?php endif; ?>">
    ...
    <a href="<?php echo e(route('user.listing.favorite.all')); ?>"
        class="menu-item  <?php if(request()->is('user/favorite/listing*')): ?> active <?php endif; ?>">
    ...
    <?php if(moduleExists('Membership')): ?>
        <?php if(membershipModuleExistsAndEnable('Membership')): ?>
            <a href="<?php echo e(route('user.enquiries.all')); ?>"
                class="menu-item <?php if(request()->routeIs('user.enquiries.all')): ?> active <?php endif; ?>">
                <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path
                        ...
                        stroke="#4A5568" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                </svg>
    ...
    <a href="<?php echo e(route('user.account.settings')); ?>"
        class="menu-item <?php if(request()->is('user/account-settings*')): ?> active <?php endif; ?>">
...
</div><?php /**PATH C:\laragon\www\Nat-Easy-Ad-Me\core\resources\views/frontend/user/layout/partials/sidebar.blade.php ENDPATH**/ ?>